...
public class Testare_Controller {
    ...
    private void btnSalvare(ActionEvent e) {
        ...
        if (numar.isEmpty() || mail.isEmpty() || comments.isEmpty() || selectedDate == null) {
            ...
            // query
            String sql = "INSERT INTO notificari (id, numar, mail, comments, verificat, data) VALUES (?, ?, ?, ?, ?,?)";
            try {
                ...
                preparedStatement.setBoolean(5, verificat); // Adăugăm valoarea CheckBox-ului
